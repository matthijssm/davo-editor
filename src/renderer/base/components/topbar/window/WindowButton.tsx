...
export class WindowButton extends React.Component<WindowButtonProps> {
    render() {
        const style = classNames({
            ...
            [styles.minimizeType]: this.props.type === WindowButtonType.MINIMIZE,
            [styles.fullscreenType]: this.props.type === WindowButtonType.FULLSCREEN,
            [styles.disabled]: this.props.disabled
        });

        return <div className={style} onClick={!this.props.disabled && this.props.onclick} />;
    }
}
